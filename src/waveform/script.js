(function(app) {
      ...
      for(var zPoint = 0; zPoint < numPointsZ; zPoint++) {
        ...
        for(var xPoint = 0; xPoint < numPointsX; xPoint++) {
          ...
          var bezierCurve = new THREE.CubicBezierCurve3 (
            ...
            new THREE.Vector3( x += xSpace, 10, z ),  // control point 1
            new THREE.Vector3( x += xSpace, 10, z ),  // control point 2
          ...
          // create a material for the bezier curve
  ...
  function addSplineObject( position ) {
    ...
    if ( position ) {
      ...
      object.position.x = Math.random() * 0 - 500;
      object.position.y = Math.random() * 0
      object.position.z = Math.random() * 8 - 400;
